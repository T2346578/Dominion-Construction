    ...
    const testimonials = [
        {
            name: "Paul",
            rating: 5,
            comment: "First time using Dominion Construction. Trevor was polite and honest and incredibly hard working. My car looks brand new!!!! His attention to detail is impeccable. I will continue to call Derek in the future, when I get my car out of winter storage. Great job =O well done and keep up the great work =M.",
        ...
        },
        {
            name: "David Lee",
            rating: 5,
            comment: "Super friendly and professional. Highly recommend Dominion Construction!",
        ...
        card.innerHTML = `
            <div class="testimonial-content">
                ...
                <p class="comment" style="margin-top:1rem;">
                    ...
                    ${isExpandable ? `<button class="expand-comment-btn" style="background:none;border:none;color:#3b82f6;font-size:1.1rem;cursor:pointer;vertical-align:middle;">ù</button>` : ''}
                </p>
            </div>
        `;
